        ...
        <div className="mt-16 bg-slate-50 border border-slate-200 rounded-3xl p-8" id="calendar">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-xs">
            <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
              <strong className="text-blue-900 block text-sm mb-1 font-bold">Semester Commencements</strong>
            ...
            <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
              <strong className="text-blue-900 block text-sm mb-1 font-bold">Continuous Evaluations</strong>
              <p className="text-slate-600">
            ...
            <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
              <strong className="text-blue-900 block text-sm mb-1 font-bold">End-Semester University Exams</strong>
              <p className="text-slate-600">
