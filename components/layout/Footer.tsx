...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#07172e] text-slate-300 pt-10 sm:pt-14 pb-14 sm:pb-8 border-t-4 border-[#c01e2e]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10 pb-8 sm:pb-12 border-b border-slate-800">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2 mb-3">
              <span className="bg-[#c01e2e] text-white text-[10px] sm:text-[11px] font-bold px-2 py-0.5 sm:px-2.5 sm:py-1 rounded">
                DTE: 6468
              </span>
            ...
            <div>
              <a
                ...
                className="inline-flex items-center gap-1.5 text-slate-300 hover:text-white text-xs font-semibold hover:underline transition-colors mt-0.5"
              >
          ...
          <div className="border-t border-slate-800/80 md:border-0 pt-4 md:pt-0">
            ...
            >
              <h4 className="text-white text-xs sm:text-sm font-bold uppercase tracking-wider md:mb-4 border-l-3 border-[#c01e2e] pl-2.5">
                B.Tech Degree (DBATU)
              </h4>
              <svg
                className={`w-4 h-4 text-slate-400 transition-transform md:hidden ${
                  openSection === "degree" ? "rotate-180 text-[#c01e2e]" : ""
                }`}
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
            ...
            >
              <li>
                <Link href="/departments/computer-engineering" className="hover:text-white transition-colors block py-0.5">
                  Computer Science &amp; Engineering
                </Link>
              </li>
              <li>
                <Link href="/departments/aiml" className="hover:text-white transition-colors block py-0.5">
                  AI &amp; Machine Learning (AI&amp;ML)
                </Link>
              </li>
              <li>
                <Link href="/departments/mechanical-engineering" className="hover:text-white transition-colors block py-0.5">
                  Mechanical Engineering
                </Link>
              </li>
              <li>
                <Link href="/departments/electrical-engineering" className="hover:text-white transition-colors block py-0.5">
                  Electrical Engineering
                </Link>
              </li>
              <li>
                <Link href="/departments/civil-engineering" className="hover:text-white transition-colors block py-0.5">
                  Civil Engineering
                </Link>
              </li>
            </ul>
          ...
          <div className="border-t border-slate-800/80 md:border-0 pt-4 md:pt-0">
            ...
            >
              ...
              <svg
                className={`w-4 h-4 text-slate-400 transition-transform md:hidden ${
                  openSection === "diploma" ? "rotate-180 text-[#c01e2e]" : ""
                }`}
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
            ...
            >
              ...
              <li>
                <Link href="/admissions" className="text-[#c01e2e] font-semibold hover:underline block py-0.5">
          ...
          <div className="border-t border-slate-800/80 md:border-0 pt-4 md:pt-0">
            ...
            >
              ...
              <svg
                className={`w-4 h-4 text-slate-400 transition-transform md:hidden ${
                  openSection === "statutory" ? "rotate-180 text-[#c01e2e]" : ""
                }`}
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
            ...
            >
              <li>
                <a href="https://www.aicte-india.org" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors block py-0.5">
                  AICTE Portal ↗
                </a>
              </li>
              <li>
                <a href="https://dte.maharashtra.gov.in" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors block py-0.5">
                  DTE Maharashtra ↗
                </a>
              </li>
              <li>
                <a href="https://dbatu.ac.in" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors block py-0.5">
                  DBATU Lonere ↗
                </a>
              </li>
              <li>
                <a href="https://msbte.org.in" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors block py-0.5">
                  MSBTE Mumbai ↗
                </a>
              </li>
              <li>
                <a href="https://mahadbt.maharashtra.gov.in" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors block py-0.5">
                  MahaDBT Scholarship ↗
                </a>
              </li>
            </ul>
