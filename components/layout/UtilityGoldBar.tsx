...
export default function UtilityGoldBar() {
  return (
    <div className="hidden md:block bg-[#001f4d] text-slate-200 py-1.5 px-4 text-xs font-medium border-b border-blue-950">
      <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-3">
        {/* Left Social Icons */}
        <div className="flex items-center gap-4">
          <span className="text-[11px] text-slate-300 uppercase tracking-wider font-semibold hidden sm:inline">
            Connect With BSIET:
          </span>
          <div className="flex items-center gap-3">
            <a
              ...
              aria-label="Facebook"
              className="text-slate-300 hover:text-white transition-transform hover:-translate-y-0.5"
            >
        ...
        <div className="flex flex-wrap items-center gap-4 sm:gap-6 text-slate-200">
          ...
          >
            <svg className="w-3.5 h-3.5 fill-[#c01e2e]" viewBox="0 0 24 24">
