    ...
    <div className="bg-[#ffcc00] text-slate-900 py-1.5 px-4 text-xs font-semibold border-b border-amber-400/40">
      <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-4">
          <span className="text-[11px] text-slate-800 uppercase tracking-wider font-bold hidden sm:inline">
            Connect With BSIET:
          </span>
          <div className="flex items-center gap-3">
            <a
              ...
              aria-label="Facebook"
              className="text-slate-800 hover:text-red-700 transition-transform hover:-translate-y-0.5"
            >
        ...
        {/* Right Contact Info */}
        <div className="flex flex-wrap items-center gap-4 sm:gap-6 text-slate-900">
          <a
            href={GMAPS_URL}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 hover:text-blue-900 hover:underline transition-colors"
          >
            <svg className="w-3.5 h-3.5 fill-red-700" viewBox="0 0 24 24">
