...
export default function FloatingActions() {
  ...
  return (
    <>
      {/* ========================================================================= */}
      {/* 1. BOTTOM-LEFT FLOATING EXPANDABLE SOCIAL RIBBON (Exact Match to Image 1) */}
      {/* ========================================================================= */}
      <aside
        aria-label="Social connect ribbon"
        className="fixed bottom-4 left-3 z-40 flex items-center select-none"
      >
        <div className="bg-[#002b66] p-1 rounded-2xl shadow-2xl border border-white/20 flex items-center gap-1">
          {/* Circular Toggle Button */}
          <button
            onClick={() => setSocialExpanded(!socialExpanded)}
            aria-label={socialExpanded ? "Collapse social links" : "Expand social links"}
          ...
          >
            <svg
              className={`w-4 h-4 fill-current transition-transform duration-300 ${
                socialExpanded ? "rotate-0" : "rotate-180"
              }`}
              viewBox="0 0 24 24"
            >
              {/* Left bookmark/arrow icon as seen in screenshot */}
          ...
          {socialExpanded && (
            <div className="flex items-center gap-1 pl-0.5 pr-1 animate-in fade-in slide-in-from-left-2 duration-200">
              {/* Facebook */}
              <a
                ...
                aria-label="Facebook"
                className="w-7 h-7 bg-white hover:bg-slate-100 rounded text-slate-900 flex items-center justify-center font-bold text-xs shadow-xs hover:scale-105 active:scale-95 transition-all"
              >
              ...
              <span className="text-white/30 text-[10px] font-thin">|</span>
      ...
      {/* ========================================================================= */}
      {/* 2. BOTTOM-RIGHT FLOATING WHATSAPP BUTTON (Exact Match to Image 2)          */}
      {/* ========================================================================= */}
      <aside
      ...
      >
        ...
        {/* WhatsApp Round Floating Button (Matches Screenshot) */}
        <a
