...
export default function HeritageMission({ onOpenEnquiry }: HeritageMissionProps) {
  const whyChooseReasons = [
    {
      icon: (
        <svg className="w-5 h-5 sm:w-6 sm:h-6 text-[#c01e2e]" viewBox="0 0 24 24" fill="currentColor">
          <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" />
        </svg>
      ),
      pill: "Prime Location",
      pillBg: "bg-red-50 text-[#c01e2e] border-red-200/70",
    ...
    {
      icon: (
        <svg className="w-5 h-5 sm:w-6 sm:h-6 text-[#002b66]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          <path strokeLinecap="round" strokeLinejoin="round" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
        </svg>
      ),
      pill: "Industry 4.0",
      pillBg: "bg-blue-50 text-[#002b66] border-blue-200/70",
  ...
  return (
    <section className="py-10 sm:py-16 px-3.5 sm:px-6 bg-slate-50/60 relative overflow-hidden" id="about">
      ...
      <div className="absolute top-1/4 -left-48 w-96 h-96 bg-blue-100/20 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-10 -right-48 w-96 h-96 bg-slate-200/40 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-6 sm:mb-10">
          <h2 className="text-xl sm:text-3xl lg:text-4xl font-extrabold text-slate-900 tracking-tight leading-tight mb-2 sm:mb-3">
            Rooted in Tradition,{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#002b66] to-[#001f4d]">
          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-7 border border-slate-200 shadow-xs hover:shadow-md transition-all">
            <div className="flex items-center justify-between gap-3 mb-2 sm:mb-3">
              <div className="flex items-center gap-2.5">
                <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-red-50 border border-red-200/60 flex items-center justify-center text-[#c01e2e] shrink-0">
              ...
              <span className="text-[9px] sm:text-[10px] font-bold uppercase tracking-wider text-[#c01e2e] bg-red-50 border border-red-200/70 px-2 py-0.5 rounded-full">
                Vision
              </span>
            </div>

            <p className="text-slate-700 text-xs sm:text-sm leading-relaxed italic border-l-3 sm:border-l-4 border-[#c01e2e] pl-3 sm:pl-4 py-1.5 sm:py-2 bg-slate-50/80 rounded-r-xl font-medium">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl sm:rounded-3xl p-4 sm:p-10 shadow-xs">
          <div className="text-center max-w-2xl mx-auto mb-5 sm:mb-10">
            <h3 className="text-lg sm:text-3xl font-extrabold text-slate-900 mb-1 sm:mb-2">
                  ...
                  <ul className="space-y-1">
                    {item.perks.map((perk, pIdx) => (
                      <li key={pIdx} className="flex items-center gap-1.5 text-[10px] sm:text-[11px] font-semibold text-slate-700">
                        <svg className="w-3 h-3 text-[#002b66] shrink-0" viewBox="0 0 20 20" fill="currentColor">
          ...
          <div className="mt-6 sm:mt-12 bg-gradient-to-r from-blue-50 to-slate-100 border border-blue-200/70 rounded-xl sm:rounded-2xl p-4 sm:p-8 text-slate-900 flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-6 shadow-xs">
            <div className="text-center sm:text-left">
              <span className="text-[10px] sm:text-[11px] font-extrabold text-[#002b66] uppercase tracking-wider block mb-0.5 sm:mb-1">
            ...
            <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto shrink-0">
              {onOpenEnquiry && (
                <button
                  ...
                  className="flex-1 sm:flex-none bg-[#c01e2e] hover:bg-[#9e1423] text-white font-bold text-xs sm:text-sm px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg shadow-md transition-all cursor-pointer whitespace-nowrap text-center"
                >
                  Enquire 2026
                </button>
              )}
