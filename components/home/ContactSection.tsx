      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 gap-2 sm:hidden mb-4">
          <a
            ...
            className="bg-white border border-blue-200 rounded-xl p-2.5 flex items-center gap-2 text-blue-900 shadow-xs active:bg-blue-50"
          >
            <span className="text-base">📞</span>
            <div className="text-left">
              <span className="text-[11px] font-bold block leading-tight">Call Helpline</span>
              <span className="text-[9px] text-blue-700">+91 7507515656</span>
            </div>
          </a>
          ...
          <a
            ...
            className="bg-white border border-emerald-200 rounded-xl p-2.5 flex items-center gap-2 text-emerald-900 shadow-xs active:bg-emerald-50"
          >
            <span className="text-base">💬</span>
            <div className="text-left">
              <span className="text-[11px] font-bold block leading-tight">WhatsApp Desk</span>
              <span className="text-[9px] text-emerald-700">Quick Response</span>
            </div>
          </a>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-8 items-stretch">
          ...
          <div className="lg:col-span-5 bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-8 border border-slate-200 shadow-xs flex flex-col justify-between">
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="flex gap-3 sm:gap-4">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-red-50 text-red-700 flex items-center justify-center shrink-0">
                ...
                <div>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1 text-red-700 hover:text-red-800 text-[11px] sm:text-xs font-bold hover:underline transition-colors mt-1.5"
                  >
              ...
              <div className="flex gap-3 sm:gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600 text-[11px] sm:text-xs leading-relaxed">
                    Officer: <a href="tel:+917507515656" className="text-blue-700 hover:underline font-bold">+91 7507515656</a><br />
                    Desk: <a href="tel:02312658610" className="text-blue-700 hover:underline">0231-2658610</a>
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-3 sm:gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600 text-[11px] sm:text-xs">
                    <a href="mailto:principal@bsiet.org" className="text-blue-700 hover:underline">
                      principal@bsiet.org
                    </a>
                  </p>
                </div>
            ...
            <div className="mt-4 sm:mt-8 pt-4 sm:pt-6 border-t border-slate-100">
              <button
                ...
                className="w-full bg-[#002b66] hover:bg-[#001f4d] text-[#ffcc00] font-bold text-xs sm:text-sm py-2.5 sm:py-3 px-4 rounded-xl shadow-xs transition-all cursor-pointer text-center"
              >
          ...
          <div className="lg:col-span-7 relative h-56 sm:h-80 lg:h-auto rounded-2xl sm:rounded-3xl overflow-hidden shadow-xs border border-slate-200">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="absolute bottom-3 right-3 sm:bottom-4 sm:right-4 bg-[#07172e] hover:bg-red-700 text-white text-[11px] sm:text-xs font-bold py-2 px-3.5 sm:py-2.5 sm:px-4 rounded-full shadow-lg border border-white/20 inline-flex items-center gap-1.5 hover:-translate-y-0.5 transition-all cursor-pointer z-10"
            >
              <svg className="w-3.5 h-3.5 fill-current text-[#ffcc00]" viewBox="0 0 24 24">
                <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" />
              </svg>
              <span>Get Directions &nearr;</span>
            </a>
          </div>
        </div>
      </div>
