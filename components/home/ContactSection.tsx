      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center max-w-2xl mx-auto mb-12">
          ...
          <p className="text-slate-600 text-sm">
            Conveniently located in the prime educational and commercial hub of Tarabai Park, Kolhapur.
          </p>
        </div>
          ...
          <div className="lg:col-span-5 bg-white rounded-3xl p-6 sm:p-8 border border-slate-200 shadow-sm flex flex-col justify-between">
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <strong className="text-slate-900 text-sm block mb-1">Campus Address:</strong>
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 text-red-700 hover:text-red-800 text-xs font-bold hover:underline transition-colors mt-2"
                  >
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <strong className="text-slate-900 text-sm block mb-1">Telephone &amp; Admissions Helpline:</strong>
                  <p className="text-slate-600 text-xs leading-relaxed">
                    Office Desk: <a href="tel:02312658610" className="text-blue-700 hover:underline">0231-2658610</a><br />
                    Admissions Officer: <a href="tel:+917507515656" className="text-blue-700 hover:underline">+91 7507515656</a>
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <strong className="text-slate-900 text-sm block mb-1">Official Email:</strong>
            ...
            <div className="mt-8 pt-6 border-t border-slate-100">
              <button
                ...
                className="w-full bg-[#002b66] hover:bg-[#001f4d] text-[#ffcc00] font-bold text-xs sm:text-sm py-3 px-4 rounded-xl shadow transition-all cursor-pointer text-center"
              >
                Schedule a Campus Visit / Enquiry
              </button>
            </div>
          </div>

          {/* Right: Interactive Map Box */}
          <div className="lg:col-span-7 relative h-[380px] lg:h-auto rounded-3xl overflow-hidden shadow-lg border border-slate-200">
            <iframe
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="absolute bottom-4 right-4 bg-[#07172e] hover:bg-red-700 text-white text-xs font-bold py-2.5 px-4 rounded-full shadow-2xl border border-white/20 inline-flex items-center gap-2 hover:-translate-y-0.5 transition-all cursor-pointer z-10"
            >
              <svg className="w-4 h-4 fill-current text-[#ffcc00]" viewBox="0 0 24 24">
                <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" />
              </svg>
              <span>Get Directions in Google Maps &nearr;</span>
            </a>
          </div>
        </div>
      </div>
